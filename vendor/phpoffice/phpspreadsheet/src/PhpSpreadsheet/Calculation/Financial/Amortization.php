...
class Amortization
{
     ...
     * the calculation depending on the life of the asset.
     * This function will return the depreciation until the last period of the life of the asset
     * or until the cumulated value of depreciation is greater than the cost of the asset minus
     * the salvage value.
     *
     * Excel Function:
