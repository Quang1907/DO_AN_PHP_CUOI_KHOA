        ...
        <div class="container max-w-3xl">
            ...
            <div class="px-7 mb-8">
                ...
                <div class="grid grid-cols-4 gap-4">
                    ...
                    <span class="mt-2">Mật khẩu: </span><button type="button" id="btnChange" class="col-span-3 text-blue-700">Thay đổi mật khẩu</button>
                </div>
                <div class="grid grid-cols-4 gap-4 mt-3" id="changePassword">
                    <span class="mt-2">Password: </span><input id="password" type="password" class="col-span-3 text-black mt-2 px-2 border-2  dark:border-gray-500 dark:text-gray-400" placeholder="Nhập mật khẩu mới">
                    <span class="mt-2">Confirm: </span><input id="confirm_password" type="password" class="col-span-3 text-black mt-2 px-2 border-2  dark:border-gray-500 dark:text-gray-400" placeholder="Nhập lại mật khẩu">
                </div>
...
<script>
    ...
    $("#editProfile").click(function() {
        ...
        var _name_address = street + ", " + ward + ", " + district + ", " + province;
        ...
        $('#email, #phoneNumber, #fullName, #birthday').prop("disabled", false);
        $('#email, #phoneNumber, #fullName, #birthday').addClass("border border-green-700");

        if ($check) {
            
            if(province == ""){
                _name_address = $("#_name_address").val();
            }
            ...
            $.ajax({
                ...
                success: function(response) {
                    ...
                    $("#divError").hide();
                    $("#error").html("");
                    $('#email, #phoneNumber, #fullName, #birthday').prop("disabled", true);
                    ...
                    if (response.status == 200) {
                        ...
                        $("#_name_address").val(_name_address);
                    }
